...
const renderTable = (data) => {
  ...
  data.map(function (val, index) {
    ...
    var text_spread = val.spread
      ? `<tr><td colspan="13"> <textarea style=" background: transparent; margin:10px; border: 0; resize: none; width: 77vw; outline: none; height: 100px; " placeholder="${val.data13}" /><td> <tr>`
      : null;
    row_num = index + 3;
